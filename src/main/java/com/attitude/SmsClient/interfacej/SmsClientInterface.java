package com.attitude.SmsClient.interfacej;

import com.attitude.SmsClient.tool.SmsClientAccessTool;
...
public class SmsClientInterface {
	...
	private static String userid = "10120";
	private static String account = "壹态网";
	...
	public static String sendSms(String mobile, String content) {
		...
		return sendSms(url, userid, account, password, mobile, content, "send",
	...
	public static String sendSms(String url, String userid, String account,
        ...
        try {
            ...
            sendParam.append("action=").append(action);
